...
class LimokaAPI:
    ...
    async def look_module(self, user_id: str, module_id) -> dict:
        ...
        async with aiohttp.ClientSession(headers=headers) as session:
            async with session.put(f'https://limoka.vsecoder.dev/api/module/look/{module_id}/{user_id}') as _:
    ...
    async def download_module(self, user_id: str, module_id) -> dict:
        ...
        async with aiohttp.ClientSession(headers=headers) as session:
            async with session.put(
                f"https://limoka.vsecoder.dev/api/module/download/{module_id}/{user_id}"
            ) as _:
                return None # api return null
